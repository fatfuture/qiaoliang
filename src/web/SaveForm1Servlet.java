...
public class SaveForm1Servlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        form1Service.queryforoneForm1Byqiaoliangmingcheng(qiaoliangmingcheng);
        int code= form1Service.saveForm1(new Form1(qiaoliangmingcheng,suozailuming,guanlidanwei,zhuliangxingsi,xingsi1,yanghudanwei,zuliangchichun,
